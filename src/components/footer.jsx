            ...
            <div className="mx-auto w-full max-w-7xl px-8">
                <div className="mx-auto grid w-full grid-cols-1 gap-8 py-12 md:grid-cols-2 lg:grid-cols-4">
                    <div className="flex flex-col pr-5">
                        <span className=" text-white font-bold uppercase text-xl">E-ShopHub</span>
                        <span className="pt-3 text-gray-200 font-normal">Redefining your shopping experience with a wide range of products and seamless delivery.</span>
                    </div>
                ...
                <div className="flex w-full flex-col items-center justify-center border-t border-white-50 py-4 md:flex-row md:justify-between">
                    ...
                    >
                        &copy; {currentYear} <a href="https://material-tailwind.com/">E-ShopHub</a>. All
                        Rights Reserved.
                    </Typography>
