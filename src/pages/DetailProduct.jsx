    ...
    <div className="bg-gradient-to-r from-gray-100 to-gray-200">
      <div className="flex flex-col lg:flex-row justify-between p-8 max-w-[1400px] mx-auto gap-6">
        ...
        <div className="flex-1 p-6 bg-white rounded-md shadow-lg">
          ...
          <p className="text-xl mb-4">Tổng tiền:</p>
      ...
      <div className="max-w-[1400px] p-6 mx-auto bg-white rounded-md shadow-lg">
        <h2 className="text-2xl font-bold mb-4 text-gray-800">Đánh giá</h2>

        {/* Bộ lọc */}
        <div className="my-6">
          <p className="text-lg mb-4">Bộ lọc:</p>
          <div className="flex flex-wrap gap-2">
            {filters.map((filter) => (
              <span
                key={filter}
                className={`px-4 py-2 rounded-lg cursor-pointer transition-all duration-300 shadow-sm ${activeFilter === filter
