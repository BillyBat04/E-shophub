...
const Listproduct = () => {
    ...
    // Render child routes (e.g., /listproduct/:id) nếu không phải là trang chính /listproduct
    ...
    const cates = [
        { id: 1, name: "Điện thoại", img: "src/assets/ph.png" },
        { id: 2, name: "Laptop", img: "src/assets/lap.png" },
        { id: 3, name: "Máy tính bảng", img: "src/assets/tab.png" },
        { id: 4, name: "Tai nghe", img: "src/assets/ears.png" },
        { id: 5, name: "Phụ kiện", img: "src/assets/access.png" },
    ];
            ...
            <div className="relative w-full h-full overflow-hidden">
                <div className="p-5 w-full mt-3 h-[20%] rounded-md bg-white flex justify-between items-center">
                    <div className="flex flex-col w-[70%]">
                        <span className="font-medium pr-3 pb-2">Khám phá theo danh mục</span>
                    ...
                    <div className="w-[30%] h-full flex flex-col items-end">
                        <div className="w-full flex items-center justify-end">
                            <span className="font-medium pr-3">Sắp xếp</span>
                            <div>
                                <Arrange />
                            </div>
                        </div>
