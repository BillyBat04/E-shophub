...
const Pdescript = () => {
    const reviews = [
        {
            ...
            rating: 5,
            date: '10/10/2024',
            reviewText: 'Một chiếc smartphone tuyệt vời!',
            images: [
        ...
        },
        {
            ...
            rating: 4,
            date: '09/10/2024',
            reviewText: 'Tính năng rất ấn tượng!',
            images: [
                'https://via.placeholder.com/80',
                'https://via.placeholder.com/80',
            ],
    ...
    return (
        <div className="h-screen w-screen">
            <div className='w-full h-[5%] flex justify-center bg-customGray'></div>
            <div className="xl:pl-[15%] xl:pr-[15%]">
                    ...
                    <div className="mt-8 col-span-3 flex flex-col justify-center items-center">
                        <div className='h-full w-auto'>
                            ...
                            <div className="flex items-center space-x-4 mt-7">
                                <div className="text-2xl flex justify-center items-center bg-black text-white rounded-full w-[300px] h-[50px] font-bold">4,490,000 VNĐ</div>
                ...
                <h2 className="text-3xl mt-10 font-semibold">Tính năng</h2>
                <div className="mt-5 overflow-x-scroll h-[400px] w-[100%]">
                    <div className="w-[1500px] flex scroll-smooth">
                        {features.map((feature, index) => (
                            ...
                            >
                                <img src={feature.src} alt={`Tính năng ${index + 1}`} className="w-full h-full rounded-xl" />
                ...
                <div className="mt-3 w-full">
                    <h2 className="text-3xl font-semibold mb-4">Đánh giá</h2>
                    <div className="flex flex-row">
                        <div className="flex flex-col h-auto w-[60%] border border-black rounded-xl space-x-4">
                            <div className="mt-7 flex h-[50px] w-full items-center justify-center">
                                ...
                                <span className="ml-5 text-2xl">15 Đánh giá</span>
                            </div>
                            <ReviewItem
                        ...
                        <div className="space-y-4 ml-5 mt-4 w-[40%]">
                            {[5, 4, 3, 2, 1].map((rating) => (
                                <div key={rating} className="flex items-center w-full">
                                    ...
                                    <span className="ml-2">{15 - (5 - rating) * 3} Đánh giá</span>
                                </div>
                            ))}
                        </div>
                    </div>
                ...
                <div className='mt-10 w-full h-[700px] bg-customGray2'>
                    <div className='p-10'>
                        <h2 className="p-5 text-3xl text-white font-semibold">Sản phẩm liên quan</h2>
                        <PhoneList />
                    </div>
                </div>
            </div>
