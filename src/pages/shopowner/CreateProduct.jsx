...
const CreateProduct = () => {
  ...
  const [computerRAM, setRAM] = useState("");
  const [computerCPU, setCPU] = useState("");
      ...
      <form
        ...
        <div className='flex flex-col gap-4'>
          <fieldset className='px-8 py-6 bg-white shadow-md rounded-xl'>
            ...
            />
            <h5 className='mt-5 font-normal text-slate-400 mb-2'>
              Description
            </h5>
            <TextareaAutosize
            ...
            />
            {category === "cm5glxf2b0000zdt1pkg7c5cy" && (
              <>
                ...
                <Input
                  ...
                  placeholder='Nhập độ phân giải Camera'
                  value={cameraMP}
        ...
        <div className='flex flex-col gap-4'>
          <fieldset className='px-8 py-6 bg-white shadow-md rounded-xl'>
            ...
            <div className='mt-3 flex items-end'>
              <h5 className='font-normal flex-grow text-slate-400 mb-2'>
                Feature Photo
              </h5>
