...
const MainPage = () => {
  ...
  return (
    <div className="h-full grid grid-rows-[auto_1fr] p-5 bg-customGray3">
      <div className="flex justify-center pb-5">
        <Header />
      </div>
      <div className="grid grid-cols-[1fr_4fr] gap-4">
        <div className="p-3 bg-white shadow-md rounded-[20px] text-sm flex flex-col justify-between">
          <Nav items={item} />
